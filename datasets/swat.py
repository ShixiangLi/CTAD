...
class SWATDataset(BaseDataset):
    def __init__(self, args, is_train=True, class_name=None):
        if class_name is not None:
            ...
            class_list = SWAT_CLASS_NAMES
        super().__init__(args, is_train, class_list)

if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', default='D:/workspace/temp/py/llm/rlr/datasets/swat/', type=str)
    ...
    dataset = SWATDataset(args, is_train=False, class_name='time_series')
