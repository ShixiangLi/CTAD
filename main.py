...
from datasets.smd import SMD_CLASS_NAMES
from datasets.psm import PSM_CLASS_NAMES
from datasets.swat import SWAT_CLASS_NAMES
from datasets.msl import MSL_CLASS_NAMES
from datasets.smap import SMAP_CLASS_NAMES
...
def main(args):
    ...
    if args.dataset == 'visa':
        ...
        class_names = SMD_CLASS_NAMES
    elif args.dataset == 'psm':
        class_names = PSM_CLASS_NAMES
    elif args.dataset == 'swat':
        class_names = SWAT_CLASS_NAMES
    elif args.dataset == 'msl':
        class_names = MSL_CLASS_NAMES
    elif args.dataset == 'smap':
        class_names = SMAP_CLASS_NAMES
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='D:/workspace/temp/py/llm/rlr/')
    # basic config
    ...
    # dataset config
    parser.add_argument('--dataset', default='msl', type=str, choices=['smd', 'psm', 'swat', 'msl', 'smap'])
    parser.add_argument('--data_path', default='D:/workspace/temp/py/llm/rlr/datasets/', type=str)
    ...
    # trainer config
    parser.add_argument('--feature_jitter', type=float, default=4)
